A idéia desse projeto é desenvolver uma API de cadastro de palestrantes no formato de um `CRUD` (**C**reate, **R**ead, **U**pdate e **D**elete) desenvolvendo os endpoints que irão ler e escrever em um arquivo utilizando o módulo `fs`.

O Projeto foi construído seguindo os passos a seguir

## 1 - Deve existir o endpoint GET `/talker`
...
## 2 - Deve existir o endpoint GET `/talker/:id`
...
## 3 - Deve existir o endpoint POST `/login`
...
## 5 - Deve existir o endpoint POST `/talker`
...
## 6 - Deve existir o endpoint PUT `/talker/:id`
...
## 7 - Deve existir o endpoint DELETE `/talker/:id`
...
## 8 - Deve existir o endpoint GET `/talker/search?q=searchTerm`
